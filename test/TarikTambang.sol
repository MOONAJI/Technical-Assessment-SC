...
contract TarikTambangTest is Test {
    ...
    function testFinalizeGame() public {
        ...
        assertEq(uint(game.result()), uint(TarikTambang.GameResult.TEAM_A_WINS));
    }
    ...
    function testDrawRefund() public {
        ...
        assertEq(uint(game.result()), uint(TarikTambang.GameResult.DRAW));
    ...
    function testGetGameInfo() public {
        ...
        assertEq(uint(gameResult), uint(TarikTambang.GameResult.PENDING));
    }
